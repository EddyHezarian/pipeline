...
import 'package:pipeline/configs/components/bottom_sheet/order_bottom_sheet.dart';
...
class OrderCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onLongPress: () {
        bottomSheet(context: context, model: model);
      },
      child: Container(
        ...
        children: [
          ...
          Row(
            children: [
              ...
              const Text("تعداد:", style: TextStyles.cartDetailsParameter2),
              Text(
