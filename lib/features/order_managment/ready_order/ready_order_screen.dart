...
class _ReadyOrderScreenState extends State<ReadyOrderScreen> {
    ...
    return SafeArea(
        child: Scaffold(
            ...
            appBar: customeMainAppBar(
                context: context, title: TextConsts.readyOrders),
            body: Column(
              children: [
                BrandSelectorContainer(
                    action: (dynamic value) {
                      ...
                      BlocProvider.of<OrderCubit>(context)
                          .loadOrders(brandName: brandName, status: "READY");
                    },
                    activator: () {
                      setState(() {
                        focusDropDown = true;
  ...
  _loadingView(BuildContext context) {
    return SafeArea(
      ...
      drawer: const CustomeDrawer(),
      backgroundColor: ColorPallet.background,
      appBar: customeMainAppBar(context: context, title: TextConsts.readyOrders),
      body: Column(
        children: [
          BrandSelectorContainer(
              action: (dynamic value) {
